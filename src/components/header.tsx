...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-64 right-0 h-16 z-30 bg-[#0D0D11] border-b border-[#27272A] px-6 flex items-center justify-between font-mono text-xs backdrop-blur-md select-none">
